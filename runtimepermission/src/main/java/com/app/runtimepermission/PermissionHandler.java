...
public class PermissionHandler {
    ...
    public PermissionListener listener = null;
    private final String TAG = getClass().getSimpleName();

    private String NOT_DEFINED_IN_MANIFEST = "requested runtime permission is not defined in your manifest";
    private String NOT_REQUIRED = "requested permission do not required runtime permission";
    private String PERMISSION_GRANTED = "permission has been granted";




    public void getPermission(Activity context, String permission, PermissionListener listener){
